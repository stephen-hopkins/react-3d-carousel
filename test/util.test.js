...
describe('Util', function() {
    describe('#figureStyle', function() {
        it('should create figure style', function() {
            ...
            expect(style.transform).to.equal(
                'rotateY(50rad)  translateX(10px) translateZ(40px)'
            );
        });
    });
    ...
    describe('#partial', function() {
        it('should return partially apllied function', function() {
            ...
            expect(sayHello('Charlie', 'Brown')).to.equal(
                'Hello, Charlie Brown!'
            );
        });
    });
    ...
    describe('#merge', function() {
        it('#should return merged object', function() {
            expect(Util.merge({ a: 1 }, { b: 2 })).to.deep.equal({
                a: 1,
                b: 2
            });
            expect(Util.merge({ a: 1, b: 3 }, { b: 2 })).to.deep.equal({
                a: 1,
                b: 2
            });
        });
